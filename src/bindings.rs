            ...
            pub mod png_glitchable {
                ...
                impl ::core::fmt::Debug for FilterType {
                    fn fmt(
                        ...
                        match self {
                            FilterType::Note => {
                                f.debug_tuple("FilterType::Note").finish()
                            }
                ...
                #[doc(hidden)]
                macro_rules! __export_gaku101_glitch_art_png_glitchable_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "gaku101:glitch-art/png-glitchable@0.1.0#glitch"] unsafe extern
                        "C" fn export_glitch(arg0 : i32, arg1 : * mut u8, arg2 : usize,)
                        -> * mut u8 { $($path_to_types)*:: _export_glitch_cabi::<$ty >
                        (arg0, arg1, arg2) } #[export_name =
                        "cabi_post_gaku101:glitch-art/png-glitchable@0.1.0#glitch"]
                        unsafe extern "C" fn _post_return_glitch(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_glitch::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_gaku101_glitch_art_png_glitchable_0_1_0_cabi;
                #[repr(align(4))]
...
macro_rules! __export_png_glitcher_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::gaku101::glitch_art::png_glitchable::__export_gaku101_glitch_art_png_glitchable_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::gaku101::glitch_art::png_glitchable);
    };
}
#[doc(inline)]
pub(crate) use __export_png_glitcher_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:gaku101:glitch-art@0.1.0:png-glitcher:encoded world"]
#[doc(hidden)]
...
A\x02\x01B\x07\x01m\x05\x04note\x03sub\x02up\x07average\x05paeth\x04\0\x0bfilter\
-type\x03\0\0\x01p}\x01r\x02\x0bfilter-type\x01\x0apixel-data\x02\x04\0\x09scan-\
line\x03\0\x03\x01@\x01\x09scan-line\x04\0\x04\x04\0\x06glitch\x01\x05\x04\0'gak\
u101:glitch-art/png-glitchable@0.1.0\x05\0\x04\0%gaku101:glitch-art/png-glitcher\
