        ...
        pub mod png_glitchable {
            ...
            impl ::core::fmt::Debug for FilterType {
                fn fmt(
                    ...
                    match self {
                        FilterType::Note => f.debug_tuple("FilterType::Note").finish(),
            ...
            pub fn glitch(scan_line: &ScanLine) -> ScanLine {
                unsafe {
                    ...
                    #[link(
                        wasm_import_module = "gaku101:glitch-art/png-glitchable@0.1.0"
                    )]
                    extern "C" {
                        #[link_name = "glitch"]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:gaku101:glitch-art@0.1.0:png-glitch-cli:encoded world"]
#[doc(hidden)]
...
line\x03\0\x03\x01@\x01\x09scan-line\x04\0\x04\x04\0\x06glitch\x01\x05\x03\0'gak\
u101:glitch-art/png-glitchable@0.1.0\x05\0\x04\0'gaku101:glitch-art/png-glitch-c\
